...
List<AchievementRecord> startingAchievements = [
  ...
  AchievementRecord(
    id: 2,
    isAchieved: false,
    title: 'Pierwsze godziny wolności',
    description: 'Wytrzymaj 1 godzinę oraz 12 godzin bez uzależnienia.',
    icon: Icons.emoji_events,
    rarity: RarityLevel.common,
  ),
  ...
  AchievementRecord(
    ...
    isAchieved: false,
    title: 'Pierwsza doba',
    description: 'Ukończ pełne 24 godziny bez powrotu do nałogu.',
    icon: Icons.emoji_events,
    rarity: RarityLevel.common,
  ),
  ...
  AchievementRecord(
    ...
    description: 'Wykonaj jedno zadanie dzienne.',
    icon: Icons.emoji_events,
    rarity: RarityLevel.common,
  ),
  ...
  AchievementRecord(
    id: 22,
    isAchieved: false,
    title: '5 wykonanych zadań',
    description: 'Ukończ łącznie 5 zadań dziennych.',
    icon: Icons.emoji_events,
    rarity: RarityLevel.common,
  ),
  ...
  AchievementRecord(
    id: 37,
    isAchieved: false,
    title: '3 dni aktywności',
    description: 'Korzystaj z aplikacji przez 3 dni z rzędu.',
    icon: Icons.emoji_events,
    rarity: RarityLevel.common,
  ),
